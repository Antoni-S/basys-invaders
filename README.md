...
Basys Invaders to gra bazowana na klasycznej grze Space Invaders, gdzie gracz ma za zadanie wyeliminować niebezpieczeństwo najeźdców z kosmosu.
Gra została napisana w języku SystemVerilog i działa na płytce Basys3, do której podłącza się ekran VGA oraz klawiaturę.
...
│   │   └── vga_timing.sv
│   ├── invaders
│   │   ├── collisions.sv          - * moduł obsługujący kolizje elementów gry
│   │   ├── display_invader.sv     - * moduł rysujący przeciwników
│   │   ├── invader_move.sv        - * moduł odpowiedzialny za ruch przeciwników
│   │   ├── invader_1.dat
│   │   ├── invader_2.dat
│   │   └── invader_3.dat
│   ├── keyboard
│   │   ├── debouncer.v
│   │   ├── keyboard_ctl.sv        - * kontroler klawiatury 
│   │   └── PS2Receiver.v 
│   ├── misc
│   │   ├── clk_divide.sv          - * moduł do dzielenia zegara
│   │   ├── delay.sv               - * moduł do opóźnienia sygnałów
│   │   ├── image_rom.sv
│   │   └── placeholder.dat
